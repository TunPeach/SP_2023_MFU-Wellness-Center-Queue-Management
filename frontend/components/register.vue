  ...
  <div>
        ...
        <v-form v-model="valid" ref="form">
          <v-container>
            ...
            <v-row>
              ...
              <v-col class="textfield">
                <v-text-field dense class="font-display" v-model="job" required background-color="#FEFCFC"
            ...
            <v-row>
              ...
              <v-col class="textfield">
                <v-text-field dense class="font-display" v-model="drug_food_allergies" outlined background-color="#FEFCFC"
    ...
    <v-dialog v-model="registerSuccess" persistent max-width="370px">
      <v-card class="font-display">
        ...
        <v-card-text> เราได้รับคำขอลงทะเบียนของท่านแล้ว กรุณารอการอนุมัติจากผู้ดูแล
          การอนุมัติคำขอนั้นจะใช้เวลาไม่เกิน 1 ชั่วโมง</v-card-text>
        <v-card-actions>
          <v-spacer></v-spacer>
...
export default {
  ...
  methods: {
    ...
    if (this.$refs.form.validate()) {
      ...
      let res = await this.$axios.post("/qmanagement/api/users", {
        name: this.name,
