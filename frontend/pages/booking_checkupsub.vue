      ...
      >
        ...
        <v-row>
          ...
          <v-col cols="6" class="d-flex align-center justify-center">
            <v-container class="d-flex align-center justify-center">
              <div class="select-time" style="margin-top: 67px">
                <h3
                  class=" font-display d-flex align-center justify-center"
                >
                  เลือกช่วงเวลา
                </h3>
                <v-card-text>
                  <v-chip-group
                    ...
                    active-class="btn-custom {"
                  >
                    <v-chip
                      outlined
                      class="font-display"
                      value="ช่วงเช้า (8.00-12.00)"
                      >ช่วงเช้า (8.00-12.00)</v-chip
                    >
                    <v-chip
                      outlined
                      class="font-display"
                      value="ช่วงบ่าย(13.00-16.00)"
                      >ช่วงบ่าย(13.00-16.00)</v-chip
                    >
                  </v-chip-group>
                </v-card-text>
                <v-container fluid>
                  <v-row align="center" justify="center">
                    <v-col cols="12" class="text-center">
                      ...
                      <v-row align="center" justify="center">
                        <h1 class="font-display" style="margin-top: 28px">
                          {{ totalQueueCount }}
                        </h1>
                        <h4
                          class="font-display"
                          style="margin-top: 34px; margin-left: 13px"
                        >
                          คิว
                        </h4>
                      </v-row>
                      ...
                      <v-card-actions>
                        <div
                          ...
                          style="margin-left: 124px; margin-top: 20px"
                        >
                          <v-btn
