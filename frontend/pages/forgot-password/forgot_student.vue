    ...
    <v-container fluid>
      <v-row align="center" justify="center">
        <v-sheet class="my-card" height="536" width="751">
          <h1 class="head-title font-display">ลืมรหัสผ่าน?</h1>
              ...
              <v-row>
                ...
                <v-col style="padding-left: 130px">
                  <!-- <a
                    ...
                    >เข้าสู่ระบบ</a
                  > -->
                  <router-link to="/loginStudent" class="forgotpassword font-display"  style="text-decoration: none; color: #61513f">เข้าสู่ระบบ</router-link>
                </v-col>
              </v-row>
              <v-btn
...
export default {
  ...
  methods: {
    login() {
      ...
      this.$axios
        .get("/qmanagement/api/forgotstudent", {
          params: {
            user: this.username,
            pass: this.email,
          },
