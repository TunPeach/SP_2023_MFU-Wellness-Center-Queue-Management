  ...
  <div>
    ...
    <v-container fluid>
      <v-row align="center" justify="center">
        <v-sheet class="my-card" height="536" width="751">
          <h1 class="head-title font-display">ลืมรหัสผ่านพนักงาน?</h1>
            ...
            <v-form @submit.prevent="login">
              ...
              <v-row>
                <!-- <v-col style="padding-right: 2px"> -->
                  ...
                  > -->
                  <!-- <router-link to="/registerAdmin" class="register font-display"  style="text-decoration: none; color: #61513f">ลงทะเบียนบัญชีใหม่</router-link>
                </v-col> -->
                <v-col style="padding-left: 130px">
                  <!-- <a
                    ...
                    >เข้าสู่ระบบ</a
                  > -->
                  <router-link to="/login" class="forgotpassword font-display"  style="text-decoration: none; color: #61513f">เข้าสู่ระบบ</router-link>
                </v-col>
              </v-row>
              <v-btn
    ...
    <v-dialog v-model="successDialog" persistent max-width="370px">
      <v-card class="font-display">
        ...
        <v-card-text>รหัสผ่านพนักงานได้ถูกส่งไปยังอีเมลของท่านที่ลงทะเบียนกับทางเราเรียบร้อย</v-card-text>
        <v-card-actions>
          <v-spacer></v-spacer>
