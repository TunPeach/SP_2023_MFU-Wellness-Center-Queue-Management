        ...
        <div class="grid-container">
          ...
          <div class="font-display ">
            ...
            >
              <v-row>
                <v-col>
                  <p class="font-display" style="padding-left: 40px; padding-top: 10px;">{{ item.subservice_name }}</p>
                </v-col>
                <v-col>
                  <p class="font-display text-right" style="padding-top: 10px; padding-right: 40px;">{{ item.subservice_price }}</p>
                </v-col>
              </v-row>
            </div>
          </div>
