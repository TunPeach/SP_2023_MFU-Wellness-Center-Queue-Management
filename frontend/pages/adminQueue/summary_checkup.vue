      ...
      <v-sheet class="box" style="
        ...
        <v-stepper v-model="e1" elevation="0" >
          <v-stepper-header class="font-display ">
            <v-stepper-step :complete="e1 > 1" step="1" color="#f17223" class="font-display "> 
              เลือกบริการ
            </v-stepper-step>
            <v-divider></v-divider>
            <v-stepper-step :complete="e1 > 2" step="2" color="#f17223" class="font-display ">
              เลือกแพ็กเกจ
            </v-stepper-step>
            <v-divider></v-divider>
            <v-stepper-step :complete="e1 > 3" step="3" color="#f17223" class="font-display ">
              บริการเพิ่มเติม
            </v-stepper-step>
            <v-divider></v-divider>
            <v-stepper-step step="4" color="#f17223" class="font-display ">
              จองคิว
            </v-stepper-step>
          </v-stepper-header>
        </v-stepper>
