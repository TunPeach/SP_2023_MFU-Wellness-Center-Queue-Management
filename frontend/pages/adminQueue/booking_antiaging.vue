                  ...
                  <v-col cols="12" class="text-center">
                    ...
                    <v-card-actions>
                      <div class="d-flex justify-center" style="margin-left: 124px; margin-top: 20px">
                        <v-btn :disabled="!selectedTime" small class="font-display"
                          style="padding-left: 30px; padding-right: 30px" color="btn-custom" rounded depressed
                          @click="goToSummary()">
                          ถัดไป
                        </v-btn>
                      </div>
...
export default {
  ...
  methods: {
    ...
    goToSummary() {
      ...
      this.$router.push({
        path: "/adminQueue/summary_antiaging",
        query: {
